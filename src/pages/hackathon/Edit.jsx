...
function HackathonEdit() {
    ...
    useEffect(() => {
        ...
        const fetchEvent = async () => {
            try {
                const res = await api.get(`/admin/event/${event}`);
    ...
    return (
        <div className="min-h-screen bg-gradient-to-b from-gray-900 to-black text-[#ECE8E7] flex justify-center items-start py-12">
            <div className="bg-gradient-to-br from-[#0f1724] to-[#071025] border border-[#1f2937] shadow-2xl rounded-3xl w-full max-w-4xl p-8 space-y-6">
                ...
                <p className="text-center text-sm text-gray-400">Update your hackathon details.</p>
                ...
                <div className="space-y-4">
                    ...
                    <div className="grid grid-cols-1 sm:grid-cols-3 gap-4">
                        <div>
                            <label className="block text-[#ECE8E7] mb-1 font-semibold">Start Date *</label>
                            <input
                                type="date"
                                className="w-full bg-[#1a1a1a] border border-[#919294]/40 rounded-lg p-2 text-[#ECE8E7] focus:outline-none focus:ring-2 focus:ring-[#E16254]"
                        ...
                        <div>
                            <label className="block text-[#ECE8E7] mb-1 font-semibold">Start Time</label>
                            <input
                                type="time"
                                className="w-full bg-[#1a1a1a] border border-[#919294]/40 rounded-lg p-2 text-[#ECE8E7] focus:outline-none focus:ring-2 focus:ring-[#E16254]"
                        ...
                        <div>
                            <label className="block text-[#ECE8E7] mb-1 font-semibold">End Date</label>
                            <input
                                type="date"
                                className="w-full bg-[#1a1a1a] border border-[#919294]/40 rounded-lg p-2 text-[#ECE8E7] focus:outline-none focus:ring-2 focus:ring-[#E16254]"
